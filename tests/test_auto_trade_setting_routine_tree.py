...
class AutoTradeSettingRoutineTreeTest(unittest.TestCase):
    ...
    def test_performance_fixture_changes_group_routine_and_stock_tree_text(self) -> None:
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            with patch.object(setting_window, "load_routine_definitions", return_value=[self._definition()]), \
                ...
                self.assertIn("color: #2563EB", _left_color(instance_a_row, "profit"))
                self.assertIn("color: #2563EB", _left_color(instance_b_row, "profit"))
                ...
                self.assertIn("color: #2563EB", _left_color(stock_a_row, "profit"))
    ...
    def test_current_and_historical_stocks_are_visually_and_operationally_separate(self) -> None:
        ...
        window._routine_tree_stock_performance_source = lambda stock: (
            performance_paths.append(str(stock.get("stock_path", "")))
            or {
                "trade_days": 0,
                "realized_profit": 0,
                "profit_rate": None,
        ...
        with (
            ...
            for label in historical_widget.findChildren(setting_window.QLabel):
                if label.objectName() == "autoTradeSettingRoutineTreeTitle" or label.objectName().startswith(
